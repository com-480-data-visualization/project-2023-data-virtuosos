!function(e, t) {
    ...
    var o = function() {
        function o() {
            ...
            i.detailedList=JSON.parse(JSON.stringify(t));

            for (let j = 0; j < 30; j++) {

                selectedTitles.push(t[j].title);
            }

            i.$container = e, i.texts = selectedTitles || [], i.config = r(r({}, o._defaultConfig), n || {}), i.radius = i.config.radius, i.depth = 2 * i.radius, i.size = 1.5 * i.radius, i.maxSpeed = o._getMaxSpeed(i.config.maxSpeed), i.initSpeed = o._getInitSpeed(i.config.initSpeed), i.direction = i.config.direction, i.keep = i.config.keep, i.paused = !1, i._createElment(), i._init(), o.list.push({
                el: i.$el,
                container: e,
                instance: i
            })
        ...
        return e = o, n = [{
            ...
            value: function() {
                ...
                e && !e.matches || (o._on(n.$el, "mouseover", function() {
                    n.active = !0
            ...
            value: function() {
                var e, t, n, a, r = this;
                r.paused || (!r.keep && !r.active && !r.paused && (r.mouseX = Math.abs(r.mouseX - r.mouseX0) < 1 ? r.mouseX0 : (r.mouseX + r.mouseX0) / 2, r.mouseY = Math.abs(r.mouseY - r.mouseY0) < 1 ? r.mouseY0 : (r.mouseY + r.mouseY0) / 2), e = -(Math.min(Math.max(-r.mouseY, -r.size), r.size) / r.radius) * r.maxSpeed, t = Math.min(Math.max(-r.mouseX, -r.size), r.size) / r.radius * r.maxSpeed, Math.abs(e) <= .01 && Math.abs(t) <= .01 || (n = Math.PI / 180, a = [Math.sin(e * n), Math.cos(e * n), Math.sin(t * n), Math.cos(t * n)], r.items.forEach(function(e) {
                    var t = e.x,
                        n = e.y * a[1] + e.z * -a[0],
                        i = e.y * a[0] + e.z * a[1],
                        o = t * a[3] + i * a[2],
            ...
            value: function(e) {
                ...
                const selectedTitles = [];
                i.detailedList=JSON.parse(JSON.stringify(e));

                for (let j = 0; j < 30; j++) {

                    selectedTitles.push(e[j].title);
                }

                i.texts = selectedTitles || [], i.texts.forEach(function(e, t) {
                    var n = i.items[t];
                    ...
                    //(a(n = i._createTextItem(e, t), i._computePosition(t, !0)), i.$el.appendChild(n.el), i.items.push(n)), n.el.innerText = e
                });
